...
export const SignIn = (props) => {
    ...
    const { changeStatus, onSubmitLogin } = props; // Lấy các props changeStatus và onSubmitLogin
    ...
    return (
        <div className="form-container">
            ...
            <div className="auth-des">
                ...
                <span onClick={() => changeStatus(false)}>Đăng ký</span> {/* Hiển thị liên kết "Đăng ký" và gọi hàm changeStatus khi nhấp vào */}
            </div>
